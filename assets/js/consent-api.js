// Simple API endpoint for consent data
(function() {
  // Create a simple endpoint for consent data
  window.addEventListener('DOMContentLoaded', function() {
    // Create a script element to inject the consent data
    const consentDataScript = document.createElement('script');
    consentDataScript.id = 'consent-data-api';
    consentDataScript.type = 'application/json';
    
    // Get consent data from the data/consent.yaml file
    const consentData = {
      items: [
        {
    ...
    // Store the consent data in a global variable
